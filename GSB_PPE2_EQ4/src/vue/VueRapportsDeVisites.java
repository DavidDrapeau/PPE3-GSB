 ...
 * @author btssio
 */
public class VueRapportsDeVisites extends javax.swing.JFrame {

    /**
     * Creates new form VueRapportsDeVisites
     */
    public VueRapportsDeVisites() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueRapportsDeVisites.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VueRapportsDeVisites().setVisible(true);
            }
        });
    }
